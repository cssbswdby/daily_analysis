...
_REPORT_LABELS: Dict[str, Dict[str, str]] = {
    "zh": {
        ...
        "chip_label": "筹码",
        "capital_flow_heading": "资金面",
        "main_net_inflow_label": "主力净流入",
        "inflow_5d_label": "5日净流入",
        "inflow_10d_label": "10日净流入",
        "sector_inflow_top_label": "资金流入靠前板块",
        "sector_outflow_top_label": "资金流出靠前板块",
        "capital_unavailable": "资金流向数据暂不可用",
    ...
    "en": {
        ...
        "capital_flow_heading": "Capital Flow",
        "main_net_inflow_label": "Main Net Inflow",
        "inflow_5d_label": "5D Net Inflow",
        "inflow_10d_label": "10D Net Inflow",
        "sector_inflow_top_label": "Top Inflow Sectors",
        "sector_outflow_top_label": "Top Outflow Sectors",
        "capital_unavailable": "Capital flow data unavailable",
    ...
    "ko": {
        ...
        "chip_label": "매물대",
        "capital_flow_heading": "자금 흐름",
        "main_net_inflow_label": "주력 순유입",
        "inflow_5d_label": "5일 순유입",
        "inflow_10d_label": "10일 순유입",
        "sector_inflow_top_label": "자금 유입 상위 섹터",
        "sector_outflow_top_label": "자금 유출 상위 섹터",
        "capital_unavailable": "자금 흐름 데이터 없음",
